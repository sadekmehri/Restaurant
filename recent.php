<div class="container">
   <h1 class="text-center"> Recent Orders <i class="fas fa-cart-arrow-down"></i></h1>
      <div class="row">
...
<?php 
  error_reporting(0);
  include "cnx.php";
  $sql="SELECT * FROM final join product using (id_product) order by (date_vente) desc limit 6";
  $test=$con->query($sql);
  $fetch=$test->num_rows;
  if($fetch>0){
