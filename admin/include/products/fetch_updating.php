...
$columns = array('id_product', 'photo','nom', 'category', 'type','price','status');
...
foreach($result as $row)
{
 ...
 $sub_array[] = '<img src="../photo/'.$row["photo"].'"name="update" class="img-thumbnail" width="125" height="125"/>';
 $sub_array[] = $row['nom'];
 $sub_array[] = $row['type'];
 $sub_array[] = $row['description'];
 $sub_array[] = '$ '.$row['price'];
 $sub_array[] = $row['status'];
 $sub_array[] = '<button class="btn btn-success" id="'.$row["id_product"].'" data-toggle="modal" data-target="#myModal" "><span class="spinner-grow spinner-grow-sm"></span> Update</button>';
 $data[] = $sub_array;
}
