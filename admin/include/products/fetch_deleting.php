...
foreach($result as $row)
{
 ...
 $sub_array[] = '<button class="btn btn-danger" id="'.$row["id_product"].'" data-toggle="modal" data-target="#myModal" "><span class="spinner-grow spinner-grow-sm"></span> Delete</button>';
 $data[] = $sub_array;
}
